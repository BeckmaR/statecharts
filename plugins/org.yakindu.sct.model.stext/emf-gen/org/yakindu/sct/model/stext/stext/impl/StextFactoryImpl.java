...
public class StextFactoryImpl extends EFactoryImpl implements StextFactory {
	 ...
	 */
	@Override
	public EventDeferExpression createEventDeferExpression() {
		EventDeferExpressionImpl eventDeferExpression = new EventDeferExpressionImpl();
		return eventDeferExpression;
	}
