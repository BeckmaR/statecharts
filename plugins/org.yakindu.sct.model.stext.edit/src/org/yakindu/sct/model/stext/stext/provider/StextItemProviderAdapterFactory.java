...
public class StextItemProviderAdapterFactory extends StextAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable
{
  ...
  /**
	 * This keeps track of the one adapter used for all {@link org.yakindu.sct.model.stext.stext.EventDeferExpression} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected EventDeferExpressionItemProvider eventDeferExpressionItemProvider;

		/**
	 * This creates an adapter for a {@link org.yakindu.sct.model.stext.stext.EventDeferExpression}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createEventDeferExpressionAdapter() {
		if (eventDeferExpressionItemProvider == null) {
			eventDeferExpressionItemProvider = new EventDeferExpressionItemProvider(this);
		}

		return eventDeferExpressionItemProvider;
	}
