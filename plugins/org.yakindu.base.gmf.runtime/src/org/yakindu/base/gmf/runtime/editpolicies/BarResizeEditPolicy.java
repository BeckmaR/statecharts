...
import org.yakindu.base.gmf.runtime.editparts.ChangeBoundsAspect;
...
public class BarResizeEditPolicy extends LiveFeedbackResizableEditPolicy {
	...
	private static class BarChangeBoundsAspect extends ChangeBoundsAspect {
		private static final int thickness = 8;

		public BarChangeBoundsAspect(EditPolicy policy) {
			super(policy);
		}
	...
	protected ChangeBoundsAspect createChangeBoundsAspect() {
		return new BarChangeBoundsAspect(this);
	}
}
